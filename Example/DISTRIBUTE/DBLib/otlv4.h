// ==============================================================
// Oracle, ODBC and DB2/CLI Template Library, Version 4.0.153,
...
#define OTL_VERSION_NUMBER (0x040099L)
...
#if defined(OTL_DEFAULT_STRING_NULL_TO_VAL)
   if((*this).is_null())
   otl_strcpy(s,OTL_DEFAULT_STRING_NULL_TO_VAL);
#endif
   OTL_TRACE_WRITE("\""<<s<<"\"","operator >>","char*")
   inc_next_ov();
   return *this;
